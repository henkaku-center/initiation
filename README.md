...
リポジトリに含まれる創作物は、素材の配置ディレクトリの `CREDITS.md` に記録しています（[assets/music/CREDITS.md](assets/music/CREDITS.md)）。追加するときの許諾と表示の手順は [CONTRIBUTING.md](CONTRIBUTING.md) にあります。
