...
| Initiation | ステップID、回答、完了日時、Initiationを開いた記録 | 進捗の保存・再表示、完走判定、どこで離脱が起きているかの把握 |
...
Initiationを開いた記録は、開いたが回答を始めなかった人を含めて人数を数えるためのものです。回答と同じく本人のウォレットアドレスに紐づけて保存しますが、個人ごとの評価や督促には利用しません。
