...
問い合わせには、対象のウォレットアドレスと希望する対応を記載してください。現在、問い合わせ元がそのウォレットの所有者本人であることを確認する方法は整備していません。このため、本人確認が必要な依頼には対応できない場合があります。シードフレーズ、秘密鍵、サービスのAPIキーを尋ねることはありません。これらをチケットへ投稿しないでください。
